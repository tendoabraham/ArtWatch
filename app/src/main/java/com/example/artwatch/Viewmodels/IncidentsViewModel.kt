...
class IncidentsViewModel : ViewModel() {
    ...
    fun createNewIncident(incidentDetails: IncidentsModel) {
        val retroService  = RetroInstance.getIncidentsRetroInstance().create(RetroServiceInterface::class.java)
        val call = retroService.createIncident(incidentDetails)
